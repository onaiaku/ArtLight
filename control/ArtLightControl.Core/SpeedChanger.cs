...
namespace ArtLightControl
{
    ...
    {
        private const string ServiceName = "ArtLightControlService";
        private const string PipeName = "ArtLightControlService";
        private const int PipeTimeoutMs = 5000;

        /// <summary>
        /// Sends the speed change command to the ArtLightControlService via Named Pipe.
        ...
        /// <summary>
        /// Asks the ArtLightControlService (LocalSystem) to write content to an apps.json path
        ...
        /// <summary>
        /// Asks the ArtLightControlService (LocalSystem) to back up the host's default
        ...
        /// <summary>
        /// Asks the ArtLightControlService (LocalSystem) to delete the custom tile PNGs
        ...
        public static bool ApplyWithUac(string adapterName, string registryValue)
        {
            ...
            string tempDir = Path.Combine(Path.GetTempPath(), "ArtLightControl");
