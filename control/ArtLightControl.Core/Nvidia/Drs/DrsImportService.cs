...
// Changes for ArtLightControl (functional capture/restore core only):
//   • namespace → ArtLightControl.Nvidia.Drs; types from ArtLightControl.Nvidia.{Native,Import}.
...
namespace ArtLightControl.Nvidia.Drs
{
    public class DrsImportService : DrsSettingsServiceBase
    {
        ...
        // ── ArtLightControl convenience: global driver profile ──────────────────────
        ...
        /// "internal" settings yield correct defaults. (ArtLightControl addition.)
        /// </summary>
