// ─────────────────────────────────────────────────────────────────────────────
// Ported from NVIDIA Profile Inspector (github.com/Orbmu2k/nvidiaProfileInspector)
//   nvidiaProfileInspector/Native/NVAPI/NvapiDrsWrapper.cs
// License: MIT — Copyright (c) 2016 Orbmu2k. See LICENSE.NPI.txt.
//
// Changes vs upstream for ArtLightControl:
//   • namespace → ArtLightControl.Nvidia.Native
//   • mock-driver branch removed (no NvapiDrsWrapper.Mock.cs ported); the
//     constructor only loads the real nvapi64.dll.
//   • `partial` removed (single file).
// Everything else (NVDRS structs, enums, the NvAPI_QueryInterface bootstrap and
// the function-ID table) is reproduced verbatim — these must match the driver ABI
// exactly, so do not "tidy" them.
// ─────────────────────────────────────────────────────────────────────────────
using System;
...
namespace ArtLightControl.Nvidia.Native
{
    ...
    [StructLayout(LayoutKind.Sequential, Pack = 8, CharSet = CharSet.Unicode)]
    public struct NVDRS_APPLICATION_V4
    {
        public bool isMetro { get { return (bitvector1 & 1) != 0; } set { if (value) bitvector1 |= 1; else bitvector1 &= ~1u; } }
        public bool isCommandLine { get { return (bitvector1 & 2) != 0; } set { if (value) bitvector1 |= 2; else bitvector1 &= ~2u; } }
    ...
    // NvAPI_SYS_GetDisplayDriverInfo → NV_DISPLAY_DRIVER_INFO_V1.
    // The bitfield is marshalled as a single uint (`bits`); bit 0 = DCH,
    // bit 1 = Studio package, bit 2 = Game Ready package, bit 3 = RTX production,
    // bit 4 = RTX new-feature. szBuildBranch is an ANSI NvAPI_ShortString[64].
    [StructLayout(LayoutKind.Sequential, Pack = 8, CharSet = CharSet.Ansi)]
    public struct NV_DISPLAY_DRIVER_INFO_V1
    {
        public uint version;
        public uint driverVersion;
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = (int)NvapiDrsWrapper.NVAPI_SHORT_STRING_MAX)]
        public string szBuildBranch;
        public uint bits;
    }
    ...
    public class NvapiDrsWrapper
    {
        ...
        public static uint NV_DISPLAY_DRIVER_INFO_VER1 = MAKE_NVAPI_VERSION<NV_DISPLAY_DRIVER_INFO_V1>(1);
        ...
        private void GetDelegate<T>(uint id, out T newDelegate, uint? fallbackId = null) where T : class
        {
        ...
        public readonly NvAPI_InitializeDelegate NvAPI_Initialize;

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate NvAPI_Status InitializeDelegate();
        public readonly InitializeDelegate Initialize;

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate NvAPI_Status UnloadDelegate();
        public readonly UnloadDelegate Unload;
        ...
        public readonly GetErrorMessageDelegate GetErrorMessage;
        ...
        public readonly GetInterfaceVersionStringDelegate GetInterfaceVersionString;
        ...
        public readonly SYS_GetDriverAndBranchVersionDelegate SYS_GetDriverAndBranchVersion;

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate NvAPI_Status NvAPI_SYS_GetDisplayDriverInfoDelegate(ref NV_DISPLAY_DRIVER_INFO_V1 pDriverInfo);
        public readonly NvAPI_SYS_GetDisplayDriverInfoDelegate NvAPI_SYS_GetDisplayDriverInfo;

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate NvAPI_Status DRS_CreateSessionDelegate(ref IntPtr phSession);
        public readonly DRS_CreateSessionDelegate DRS_CreateSession;

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate NvAPI_Status DRS_DestroySessionDelegate(IntPtr hSession);
        public readonly DRS_DestroySessionDelegate DRS_DestroySession;

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate NvAPI_Status DRS_LoadSettingsDelegate(IntPtr hSession);
        public readonly DRS_LoadSettingsDelegate DRS_LoadSettings;

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate NvAPI_Status DRS_SaveSettingsDelegate(IntPtr hSession);
        public readonly DRS_SaveSettingsDelegate DRS_SaveSettings;
        ...
        public readonly DRS_LoadSettingsFromFileDelegate DRS_LoadSettingsFromFile;
        ...
        public readonly DRS_SaveSettingsToFileDelegate DRS_SaveSettingsToFile;
        ...
        public readonly DRS_LoadSettingsFromFileExDelegate DRS_LoadSettingsFromFileEx;
        ...
        public readonly DRS_SaveSettingsToFileExDelegate DRS_SaveSettingsToFileEx;
        ...
        public readonly DRS_CreateProfileDelegate DRS_CreateProfile;

        [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
        public delegate NvAPI_Status DRS_DeleteProfileDelegate(IntPtr hSession, IntPtr hProfile);
        public readonly DRS_DeleteProfileDelegate DRS_DeleteProfile;
        ...
        public readonly DRS_CreateApplicationDelegate DRS_CreateApplication;
        ...
        public readonly DRS_DeleteApplicationExDelegate DRS_DeleteApplicationEx;
        ...
        public readonly DRS_DeleteApplicationDelegate DRS_DeleteApplication;
        ...
        public readonly DRS_GetApplicationInfoDelegate DRS_GetApplicationInfo;
        ...
        private readonly DRS_EnumApplicationsDelegate DRS_EnumApplicationsInternal;
        public NvAPI_Status DRS_EnumApplications<TDrsAppVersion>(IntPtr hSession, IntPtr hProfile, uint startIndex, ref uint appCount, ref TDrsAppVersion[] apps)
        {
            NvAPI_Status res;
        ...
        public readonly DRS_FindApplicationByNameDelegate DRS_FindApplicationByName;

        public NvAPI_Status DRS_SetSetting(IntPtr hSession, IntPtr hProfile, ref NVDRS_SETTING pSetting)
        {
            return _DRS_SetSetting(hSession, hProfile, ref pSetting, 0, 0);
        }

        public NvAPI_Status DRS_GetSetting(IntPtr hSession, IntPtr hProfile, uint settingId, ref NVDRS_SETTING pSetting)
        {
            uint x = 0;
        ...
        private readonly DRS_SetSettingDelegate _DRS_SetSetting;
        ...
        private readonly DRS_GetSettingDelegate _DRS_GetSetting;
        ...
        private readonly DRS_EnumSettingsDelegate DRS_EnumSettingsInternal;
        public NvAPI_Status DRS_EnumSettings(IntPtr hSession, IntPtr hProfile, uint startIndex, ref uint settingsCount, ref NVDRS_SETTING[] settings)
        {
            NvAPI_Status res;
        ...
        public readonly DRS_EnumAvailableSettingIdsDelegate DRS_EnumAvailableSettingIdsInternal;
        public NvAPI_Status DRS_EnumAvailableSettingIds(out List<uint> settingIds, uint maxCount)
        {
            NvAPI_Status res;
        ...
        private readonly DRS_EnumAvailableSettingValuesDelegate DRS_EnumAvailableSettingValuesInternal;
        public NvAPI_Status DRS_EnumAvailableSettingValues(uint settingId, ref uint pMaxNumValues, ref NVDRS_SETTING_VALUES settingValues)
        {
        ...
        public readonly DRS_GetSettingIdFromNameDelegate DRS_GetSettingIdFromName;
        ...
        private NvapiDrsWrapper()
        {
            ...
            if (lib != IntPtr.Zero)
            {
                ...
                if (nvapi_QueryInterface != null)
                {
                    ...
                    if (NvAPI_Initialize != null && NvAPI_Initialize() == NvAPI_Status.NVAPI_OK)
                    {
                        #region FUNCTION IDs
                        ...
                        GetDelegate(0x721FACEB, out NvAPI_SYS_GetDisplayDriverInfo);
