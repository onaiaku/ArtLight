...
{
    /// <summary>
    /// Reads and writes config.json (%LOCALAPPDATA%\ArtLightControl\config.json).
    ...
    public static class ConfigService
    {
        ...
        private static void Patch(Action<JsonObject> mutate)
        {
            ...
            catch (Exception ex) { ArtLightControl.DebugLogger.Log($"[Config] Set failed: {ex.Message}"); }
        }
    }
}
