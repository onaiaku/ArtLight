...
TEST_F(UtfUtilsTest, FromUtf8WithQuotationMarks) {
  ...
  const std::string left_quote = "Device \u2018Audio\u2019 Output";  // Unicode left/right single quotes
  const std::string right_quote = "Device \u2019Audio\u2018 Output";  // Unicode right/left single quotes
  const std::string left_double = "Device \u201CAudio\u201D Output";  // Unicode left/right double quotes
  const std::string right_double = "Device \u201DAudio\u201C Output";  // Unicode right/left double quotes
  ...
  EXPECT_EQ(result3, L"Device \u2018Audio\u2019 Output") << "Left quote conversion failed";
  EXPECT_EQ(result4, L"Device \u2019Audio\u2018 Output") << "Right quote conversion failed";
  EXPECT_EQ(result5, L"Device \u201CAudio\u201D Output") << "Left double quote conversion failed";
  EXPECT_EQ(result6, L"Device \u201DAudio\u201C Output") << "Right double quote conversion failed";
}
...
TEST_F(UtfUtilsTest, ToUtf8WithQuotationMarks) {
  ...
  const std::wstring left_quote = L"Device \u2018Audio\u2019 Output";  // Unicode left/right single quotes
  const std::wstring right_quote = L"Device \u2019Audio\u2018 Output";  // Unicode right/left single quotes
  const std::wstring left_double = L"Device \u201CAudio\u201D Output";  // Unicode left/right double quotes
  const std::wstring right_double = L"Device \u201DAudio\u201C Output";  // Unicode right/left double quotes
  ...
  EXPECT_EQ(result3, "Device \u2018Audio\u2019 Output") << "Left quote to UTF-8 conversion failed";
  EXPECT_EQ(result4, "Device \u2019Audio\u2018 Output") << "Right quote to UTF-8 conversion failed";
  EXPECT_EQ(result5, "Device \u201CAudio\u201D Output") << "Left double quote to UTF-8 conversion failed";
  EXPECT_EQ(result6, "Device \u201DAudio\u201C Output") << "Right double quote to UTF-8 conversion failed";
}
...
TEST_F(UtfUtilsTest, RoundTripConversionWithSpecialCharacters) {
  ...
  const std::string quotes = "Device 'Audio' with \u201CSpecial\u201D Characters";
