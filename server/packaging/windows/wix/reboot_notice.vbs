...
Sub ShowRebootNotice
    Dim message
    message = "No reboot is needed when installing, upgrading, or uninstalling Vibepollo." & vbCrLf & vbCrLf & _
              "Vibepollo uses an MSI installer, which enables seamless in-place upgrades and unattended installs." & vbCrLf & _
