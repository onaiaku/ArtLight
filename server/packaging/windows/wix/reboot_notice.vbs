...
Sub ShowRebootNotice
    Dim message
    message = "No reboot is needed when installing, upgrading, or uninstalling ArtLight Server." & vbCrLf & vbCrLf & _
              "ArtLight Server uses an MSI installer, which enables seamless in-place upgrades and unattended installs." & vbCrLf & _
