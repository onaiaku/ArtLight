Function WaitForLegacyUninstall()
    Dim shell, regKey64, regKey32, sunshinePresent, maxWaitSeconds, elapsedSeconds
    ...
    sunshinePresent = True

    Do While elapsedSeconds < maxWaitSeconds And sunshinePresent
        ' Use ping as a sleep mechanism (MSI context doesn't have WScript.Sleep)
        shell.Run "ping 127.0.0.1 -n 2", 0, True
        elapsedSeconds = elapsedSeconds + 1

        ' Check if Sunshine is still present
        sunshinePresent = False
