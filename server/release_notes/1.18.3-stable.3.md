...
> [!IMPORTANT]
> Artemis clients must enable **Use virtual display** to use a virtual display; Artemis leaves this option off by default. Vibepollo now reports virtual-display capability to Artemis so it no longer shows an unsupported-host warning.
