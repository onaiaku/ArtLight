# ArtLight Server 1.18.0-beta.4 - 2026-07-03
...
- Replaced the inverted "Use SudoVDA" checkbox with a "Virtual display driver" dropdown (ArtLight Server Display Driver recommended, SudoVDA legacy) in both the WebUI and the installer.
